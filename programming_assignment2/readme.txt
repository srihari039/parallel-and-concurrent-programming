...
Compilation:
    ...
    Create input file with n,k,lambda1,lambda2 respectively with name inp-params.txt

Execution:
    command : $ ./exec
    If proper input file is present, it gives out output.txt file.
    It contains every cs entry request time, every cs entry time, every cs exit request time and every cs exit time.
